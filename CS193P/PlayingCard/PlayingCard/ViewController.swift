...
class ViewController: UIViewController {
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        CMMotionManager.shared.startAccelerometerUpdates()
    }
    ...
    @objc func flipCard(_ recongizer:UITapGestureRecognizer){
        switch recongizer.state {
        case .ended:
            if let chosenCardView = recongizer.view as? PlayingCardView, faceUpCardViews.count < 2 {
